...
def main(args=None):
    ...
    resolution_rows, resolution_charges, resolution_results_ext = None, None, None
    if args.resolution_at is not None:
    ...
    if resolution_results_ext is not None and (
        args.plot_resolution_individual or args.plot_resolution_together
    ):
        plot_resolution(
